...
from app_neilytaTec1.views import home, listagem, listarProf
from app_neilytaTec1.views import listarAlunos, listarCursos
from app_neilytaTec1.views import update, remove, create
