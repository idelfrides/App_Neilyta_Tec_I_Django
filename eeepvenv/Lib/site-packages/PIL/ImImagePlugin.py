...
# 1997-01-03 fl   Save palette images2
# 1997-01-08 fl   Added sequence support
# 1997-01-23 fl   Added P and RGB save support
# 1997-05-31 fl   Read floating point images2
# 1997-06-22 fl   Save floating point images2
# 1997-08-27 fl   Read and save 1-bit images2
# 1998-06-25 fl   Added support for RGB+LUT images2
# 1998-07-02 fl   Added support for YCC images2
...
FRAMES = "File size (no of images2)"
LUT = "Lut"
NAME = "Name"
SCALE = "Scale (x,y)"
SIZE = "Image size (x*y)"
...
def _save(im, fp, filename):
    ...
    try:
        ...
        raise ValueError("Cannot save %s images2 as IM" % im.mode)
    ...
    fp.write(("File size (no of images2): %d\r\n" % frames).encode('ascii'))
    if im.mode == "P":
        fp.write(b"Lut: 1\r\n")
