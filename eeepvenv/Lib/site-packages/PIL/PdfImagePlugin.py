...
# 2004-02-21 fl   Fixes for 1/L/CMYK images2, etc.
# 2004-02-24 fl   Fixes for 1 and P images2.
#
...
##
# Image plugin for PDF images2 (output only).
##
        ...
        for im in im_pages:
            ...
            if filter == "ASCIIHexDecode":
                if bits == 1:
                    ...
                    # images2; do things the hard way...
