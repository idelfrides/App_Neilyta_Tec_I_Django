...
# 1998-07-12 fl   Read/write 16-bit images2 as mode I (0.4)
...
# 2008-08-13 fl   Added tRNS support for RGB images2
...
def _save(im, fp, filename, chunk=putchunk):
    ...
    if mode == "P":
        ...
        #
        # attempt to minimize storage requirements for palette images2
