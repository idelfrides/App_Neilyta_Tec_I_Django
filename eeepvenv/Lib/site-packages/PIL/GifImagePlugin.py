...
# 2004-02-24 fl   Disable interlacing for small images2
#
...
##
# Image plugin for GIF images2.  This plugin supports both GIF87 and
# GIF89 images2.
    ...
    def seek(self, frame):
        ...
        for f in range(self.__frame + 1, frame + 1):
            try:
                ...
                raise EOFError("no more images2 in GIF file")
...
def _normalize_palette(im, palette, info):
    ...
    Normalizes the palette for image.
      ...
      - Ensures that there's a palette for L mode images2
