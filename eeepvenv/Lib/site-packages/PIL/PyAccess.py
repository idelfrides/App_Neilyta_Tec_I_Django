...
class PyAccess(object):
    ...
    def __setitem__(self, xy, color):
        ...
        numerical value for single band images2, and a tuple for
        multi-band images2
    ...
    def __getitem__(self, xy):
        ...
        value for single band images2 or a tuple for multiple band
        images2

        :param xy: The pixel coordinate, given as (x, y). See
          :ref:`coordinate-system`.
        :returns: a pixel value for single band images2, a tuple of
          pixel values for multiband images2.
        """
        (x, y) = xy
        if x < 0:
            x = self.xsize + x
...
class _PyAccess8(PyAccess):
    """ 1, L, P, 8 bit images2 stored as uint8 """
    def _post_init(self, *args, **kwargs):
