...
def getmodebase(mode):
    ...
    images2 that contain grayscale data, and "RGB" for images2 that
    contain color data.
...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def close(self):
        ...
        This function is only required to close images2 that have not
    ...
    def __array_interface__(self):
        ...
        new['version'] = 3
        if self.mode == '1':
            # Binary images2 need to be extended from bits to bytes
    ...
    def tobitmap(self, name="image"):
        ...
        .. note:: This method only works for mode "1" images2.
        ...
        if has_transparency:
            if self.mode in ('1', 'L', 'I', 'RGB') and mode == 'RGBA':
                ...
                if isinstance(t, bytes):
                    ...
                    warnings.warn('Palette images2 with Transparency  ' +
    ...
    def quantize(self, colors=256, method=None, kmeans=0, palette=None, dither=1):
        ...
        if self.mode == 'RGBA' and method not in (2, 3):
            ...
            raise ValueError(
                ...
                'are the only valid methods for quantizing RGBA images2')
        ...
        if palette:
            ...
            if self.mode != "RGB" and self.mode != "L":
                raise ValueError(
                    "only RGB or L mode images2 can be quantized to a palette"
                    )
    ...
    def draft(self, mode, size):
        ...
        Note: This method is not implemented for most images2. It is
        currently implemented only for JPEG and PCD images2.
    ...
    def paste(self, im, box=None, mask=None):
        ...
        with the given color.  When creating RGB images2, you can
        also use color strings as supported by the ImageColor module.

        If a mask is given, this method updates only the regions
        indicated by the mask.  You can use either "1", "L" or "RGBA"
        images2 (in the latter case, the alpha band is used as mask).
        Where the mask is 255, the given image is copied as is.  Where
        the mask is 0, the current value is preserved.  Intermediate
        values will mix the two images2 together, including their alpha
        channels if they have them.

        See :py:meth:`~PIL.Image.Image.alpha_composite` if you want to
        combine images2 with respect to their alpha channels.
    ...
    def point(self, lut, mode=None):
        ...
        if callable(lut):
            ...
            if self.mode in ("I", "I;16", "F"):
                ...
                # a gamma function point transform on > 8bit images2.
    ...
    def putpixel(self, xy, value):
        ...
        a single numerical value for single-band images2, and a tuple for
        multi-band images2. In addition to this, RGB and RGBA tuples are
        accepted for P images2.
    ...
    def remap_palette(self, dest_map, source_palette=None):
        ...
        # Palette images2 are [0..255], mapped through a 1 or 3
    ...
    def split(self):
        ...
        splitting an "RGB" image creates three new images2 each
...
def new(mode, size, color=0):
    ...
    :param color: What color to use for the image.  Default is black.
       ...
       per band).  When creating RGB images2, you can also use color
...
def frombytes(mode, size, data, decoder_name="raw", *args):
    ...
    Note that this function decodes pixel data only, not entire images2.
...
def blend(im1, im2, alpha):
    """
    Creates a new image by interpolating between two input images2, using
    a constant alpha.::
...
def composite(image1, image2, mask):
    """
    Create composite image by blending images2 using a transparency mask.
...
def merge(mode, bands):
    """
    Merge a set of single band images2 into a new multiband image.
...
def register_open(id, factory, accept=None):
    ...
    :param accept: An optional function that can be used to quickly
       reject images2 having another format.
    """
    id = id.upper()
    ID.append(id)
...
def register_save(id, driver):
    ...
    :param id: An image format identifier.
    :param driver: A function to save images2 in this format.
    """
