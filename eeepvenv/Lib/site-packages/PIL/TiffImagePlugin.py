...
OPEN_INFO = {
    ...
    # JPEG compressed images2 handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr images2 to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame):
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                raise EOFError("no more images2 in TIFF file")
            if DEBUG:
    ...
    def _setup(self):
        ...
        # old style jpeg compression images2 most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 images2 will fail if we use that
            # function.
            #
...
def _save(im, fp, filename):
    ...
    # required for color libtiff images2
